  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Publication.instructor() instead.
        "prototype$__get__instructor": {
          url: urlBase + "/publications/:id/instructor",
          method: "GET"
        },

        // INTERNAL. Use Publication.comments.findById() instead.
        ...
        // INTERNAL. Use Publication.comments.destroyById() instead.
        ...
        // INTERNAL. Use Publication.comments.updateById() instead.
        ...
        // INTERNAL. Use Publication.comments() instead.
        ...
        // INTERNAL. Use Publication.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/publications/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Publication.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/publications/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Publication.comments.count() instead.
        ...
        // INTERNAL. Use Instructor.publications.findById() instead.
        "::findById::Instructor::publications": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/publications/:fk",
          method: "GET"
        },

        // INTERNAL. Use Instructor.publications.destroyById() instead.
        "::destroyById::Instructor::publications": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/publications/:fk",
        ...
        // INTERNAL. Use Instructor.publications.updateById() instead.
        "::updateById::Instructor::publications": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/publications/:fk",
        ...
        // INTERNAL. Use Instructor.publications() instead.
        "::get::Instructor::publications": {
          isArray: true,
          url: urlBase + "/instructors/:id/publications",
          method: "GET"
        },

        // INTERNAL. Use Instructor.publications.create() instead.
        "::create::Instructor::publications": {
          url: urlBase + "/instructors/:id/publications",
          method: "POST"
        },

        // INTERNAL. Use Instructor.publications.createMany() instead.
        "::createMany::Instructor::publications": {
          isArray: true,
          url: urlBase + "/instructors/:id/publications",
          method: "POST"
        },

        // INTERNAL. Use Instructor.publications.destroyAll() instead.
        "::delete::Instructor::publications": {
          url: urlBase + "/instructors/:id/publications",
          method: "DELETE"
        },

        // INTERNAL. Use Instructor.publications.count() instead.
        "::count::Instructor::publications": {
          url: urlBase + "/instructors/:id/publications/count",
          method: "GET"
        },

        // INTERNAL. Use Comment.publication() instead.
        "::get::Comment::publication": {
          url: urlBase + "/comments/:id/publication",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Publication";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Publication#instructor
         * @methodOf lbServices.Publication
         *
         * @description
         *
        ...
        R.instructor = function() {
          ...
          var action = TargetResource["::get::Publication::instructor"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Publication.comments
     * @header lbServices.Publication.comments
     * @object
     * @description
     *
     * The object `Publication.comments` groups methods
     * manipulating `Comment` instances related to `Publication`.
     *
     * Call {@link lbServices.Publication#comments Publication.comments()}
     ...
     */
        ...
        R.comments = function() {
          ...
          var action = TargetResource["::get::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#count
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#create
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#createMany
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#destroyAll
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#destroyById
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#findById
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::Publication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Publication.comments#updateById
         * @methodOf lbServices.Publication.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::Publication::comments"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.PublicPublication
 * @header lbServices.PublicPublication
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `PublicPublication` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/publicpublications/:id",
      { 'id': '@id' },
      {

        // INTERNAL. Use PublicPublication.instructor() instead.
        "prototype$__get__instructor": {
          url: urlBase + "/publicpublications/:id/instructor",
          method: "GET"
        },

        // INTERNAL. Use PublicPublication.comments.findById() instead.
        "prototype$__findById__comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/publicpublications/:id/comments/:fk",
          method: "GET"
        },

        // INTERNAL. Use PublicPublication.comments.destroyById() instead.
        "prototype$__destroyById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use PublicPublication.comments.updateById() instead.
        "prototype$__updateById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use PublicPublication.comments() instead.
        "prototype$__get__comments": {
          isArray: true,
          url: urlBase + "/publicpublications/:id/comments",
          method: "GET"
        },

        // INTERNAL. Use PublicPublication.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/publicpublications/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use PublicPublication.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/publicpublications/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use PublicPublication.comments.count() instead.
        "prototype$__count__comments": {
          url: urlBase + "/publicpublications/:id/comments/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#create
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `PublicPublication` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/publicpublications",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#createMany
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#upsert
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#exists
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/publicpublications/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#findById
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/publicpublications/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#find
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#findOne
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/publicpublications/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#updateAll
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/publicpublications/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#deleteById
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#count
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/publicpublications/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#prototype$updateAttributes
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#createChangeStream
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/publicpublications/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#updateOrCreate
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#update
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#destroyById
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#removeById
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.PublicPublication#modelName
    * @propertyOf lbServices.PublicPublication
    * @description
    * The name of the model represented by this $resource,
    * i.e. `PublicPublication`.
    */
    R.modelName = "PublicPublication";


        /**
         * @ngdoc method
         * @name lbServices.PublicPublication#instructor
         * @methodOf lbServices.PublicPublication
         *
         * @description
         *
        ...
        R.instructor = function() {
          var TargetResource = $injector.get("Instructor");
          var action = TargetResource["::get::PublicPublication::instructor"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.PublicPublication.comments
     * @header lbServices.PublicPublication.comments
     * @object
     * @description
     *
     * The object `PublicPublication.comments` groups methods
     * manipulating `Comment` instances related to `PublicPublication`.
     *
     * Call {@link lbServices.PublicPublication#comments PublicPublication.comments()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries comments of PublicPublication.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - Publication id
        ...
        R.comments = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::get::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#count
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
         * Counts comments of PublicPublication.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - Publication id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#create
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#createMany
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#destroyAll
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#destroyById
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#findById
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::PublicPublication::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.PublicPublication.comments#updateById
         * @methodOf lbServices.PublicPublication.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::PublicPublication::comments"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use AppUser.comments.findById() instead.
        "prototype$__findById__comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/appusers/:id/comments/:fk",
          method: "GET"
        },

        // INTERNAL. Use AppUser.comments.destroyById() instead.
        "prototype$__destroyById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use AppUser.comments.updateById() instead.
        "prototype$__updateById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use AppUser.gender() instead.
        "prototype$__get__gender": {
          url: urlBase + "/appusers/:id/gender",
          method: "GET"
        },
        ...
        // INTERNAL. Use AppUser.comments() instead.
        "prototype$__get__comments": {
          isArray: true,
          url: urlBase + "/appusers/:id/comments",
          method: "GET"
        },

        // INTERNAL. Use AppUser.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/appusers/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use AppUser.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/appusers/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use AppUser.comments.count() instead.
        "prototype$__count__comments": {
          url: urlBase + "/appusers/:id/comments/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.AppUser.comments
     * @header lbServices.AppUser.comments
     * @object
     * @description
     *
     * The object `AppUser.comments` groups methods
     * manipulating `Comment` instances related to `AppUser`.
     *
     * Call {@link lbServices.AppUser#comments AppUser.comments()}
     * to query all related instances.
     */
        ...
        R.comments = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::get::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#count
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
         * Counts comments of AppUser.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#create
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#createMany
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#destroyAll
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#destroyById
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#findById
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser.comments#updateById
         * @methodOf lbServices.AppUser.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::AppUser::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.AppUser#gender
         * @methodOf lbServices.AppUser
         *
         * @description
         *
        ...
        R.gender = function() {
          ...
          var action = TargetResource["::get::AppUser::gender"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Instructor.publications.findById() instead.
        "prototype$__findById__publications": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/publications/:fk",
        ...
        // INTERNAL. Use Instructor.publications.destroyById() instead.
        "prototype$__destroyById__publications": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/publications/:fk",
        ...
        // INTERNAL. Use Instructor.publications.updateById() instead.
        "prototype$__updateById__publications": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/publications/:fk",
        ...
        // INTERNAL. Use Instructor.comments.findById() instead.
        "prototype$__findById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Instructor.comments.destroyById() instead.
        "prototype$__destroyById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Instructor.comments.updateById() instead.
        "prototype$__updateById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Instructor.gender() instead.
        "prototype$__get__gender": {
          url: urlBase + "/instructors/:id/gender",
          method: "GET"
        },
        ...
        // INTERNAL. Use Instructor.publications.create() instead.
        "prototype$__create__publications": {
          url: urlBase + "/instructors/:id/publications",
          method: "POST"
        },

        // INTERNAL. Use Instructor.publications.destroyAll() instead.
        "prototype$__delete__publications": {
          url: urlBase + "/instructors/:id/publications",
          method: "DELETE"
        },

        // INTERNAL. Use Instructor.publications.count() instead.
        "prototype$__count__publications": {
          url: urlBase + "/instructors/:id/publications/count",
          method: "GET"
        },

        // INTERNAL. Use Instructor.comments() instead.
        "prototype$__get__comments": {
          isArray: true,
        ...
        // INTERNAL. Use Instructor.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/instructors/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Instructor.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/instructors/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Instructor.comments.count() instead.
        "prototype$__count__comments": {
        ...
        // INTERNAL. Use Publication.instructor() instead.
        "::get::Publication::instructor": {
          url: urlBase + "/publications/:id/instructor",
          method: "GET"
        },

        // INTERNAL. Use PublicPublication.instructor() instead.
        "::get::PublicPublication::instructor": {
          url: urlBase + "/publicpublications/:id/instructor",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Instructor.publications
     * @header lbServices.Instructor.publications
     * @object
     * @description
     *
     * The object `Instructor.publications` groups methods
     * manipulating `Publication` instances related to `Instructor`.
     *
     * Call {@link lbServices.Instructor#publications Instructor.publications()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries publications of Instructor.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         ...
         * </em>
         */
        R.publications = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::get::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#count
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         * Counts publications of Instructor.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         ...
         *  - `count` – `{number=}` - 
         */
        R.publications.count = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::count::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#create
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         * Creates a new instance in publications of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         ...
         * </em>
         */
        R.publications.create = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::create::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#createMany
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         ...
         * </em>
         */
        R.publications.createMany = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::createMany::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#destroyAll
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         * Deletes all publications of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         ...
         * This method returns no data.
         */
        R.publications.destroyAll = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::delete::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#destroyById
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         * Delete a related item by id for publications.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         *
         *  - `fk` – `{*}` - Foreign key for publications
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.publications.destroyById = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::destroyById::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#findById
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         * Find a related item by id for publications.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         ...
         * </em>
         */
        R.publications.findById = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::findById::Instructor::publications"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.publications#updateById
         * @methodOf lbServices.Instructor.publications
         *
         * @description
         *
         * Update a related item by id for publications.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - AppUser id
         ...
         * </em>
         */
        R.publications.updateById = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::updateById::Instructor::publications"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Instructor.comments
     * @header lbServices.Instructor.comments
     * @object
     * @description
     *
     * The object `Instructor.comments` groups methods
     * manipulating `Comment` instances related to `Instructor`.
     *
     * Call {@link lbServices.Instructor#comments Instructor.comments()}
     * to query all related instances.
     */
        ...
        R.comments = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::get::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#count
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#create
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#createMany
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#destroyAll
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#destroyById
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#findById
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor.comments#updateById
         * @methodOf lbServices.Instructor.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::Instructor::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Instructor#gender
         * @methodOf lbServices.Instructor
         *
         * @description
         *
        ...
        R.gender = function() {
          var TargetResource = $injector.get("Gender");
          var action = TargetResource["::get::Instructor::gender"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Student.comments.findById() instead.
        "prototype$__findById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Student.comments.destroyById() instead.
        "prototype$__destroyById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Student.comments.updateById() instead.
        "prototype$__updateById__comments": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Student.comments() instead.
        "prototype$__get__comments": {
          isArray: true,
        ...
        // INTERNAL. Use Student.comments.create() instead.
        "prototype$__create__comments": {
          url: urlBase + "/students/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use Student.comments.destroyAll() instead.
        "prototype$__delete__comments": {
          url: urlBase + "/students/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use Student.comments.count() instead.
        "prototype$__count__comments": {
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Student.comments
     * @header lbServices.Student.comments
     * @object
     * @description
     *
     * The object `Student.comments` groups methods
     * manipulating `Comment` instances related to `Student`.
     *
     * Call {@link lbServices.Student#comments Student.comments()}
     * to query all related instances.
     */
        ...
        R.comments = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::get::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#count
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#create
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#createMany
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#destroyAll
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#destroyById
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#findById
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::Student::comments"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Student.comments#updateById
         * @methodOf lbServices.Student.comments
         *
         * @description
         *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::Student::comments"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Publication.comments.destroyById() instead.
        "::destroyById::Publication::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/publications/:id/comments/:fk",
        ...
        // INTERNAL. Use Publication.comments.updateById() instead.
        "::updateById::Publication::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/publications/:id/comments/:fk",
        ...
        // INTERNAL. Use Publication.comments.createMany() instead.
        "::createMany::Publication::comments": {
          isArray: true,
          url: urlBase + "/publications/:id/comments",
          method: "POST"
        },
        ...
        // INTERNAL. Use PublicPublication.comments.findById() instead.
        "::findById::PublicPublication::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/publicpublications/:id/comments/:fk",
        ...
        // INTERNAL. Use PublicPublication.comments.destroyById() instead.
        "::destroyById::PublicPublication::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/publicpublications/:id/comments/:fk",
        ...
        // INTERNAL. Use PublicPublication.comments.updateById() instead.
        "::updateById::PublicPublication::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/publicpublications/:id/comments/:fk",
        ...
        // INTERNAL. Use PublicPublication.comments() instead.
        "::get::PublicPublication::comments": {
          isArray: true,
          url: urlBase + "/publicpublications/:id/comments",
          method: "GET"
        },
        ...
        // INTERNAL. Use PublicPublication.comments.create() instead.
        "::create::PublicPublication::comments": {
          url: urlBase + "/publicpublications/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use PublicPublication.comments.createMany() instead.
        "::createMany::PublicPublication::comments": {
          isArray: true,
          url: urlBase + "/publicpublications/:id/comments",
          method: "POST"
        },
        ...
        // INTERNAL. Use PublicPublication.comments.destroyAll() instead.
        "::delete::PublicPublication::comments": {
          url: urlBase + "/publicpublications/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use PublicPublication.comments.count() instead.
        "::count::PublicPublication::comments": {
          url: urlBase + "/publicpublications/:id/comments/count",
          method: "GET"
        },

        // INTERNAL. Use AppUser.comments.findById() instead.
        "::findById::AppUser::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/appusers/:id/comments/:fk",
        ...
        // INTERNAL. Use AppUser.comments.create() instead.
        "::create::AppUser::comments": {
          url: urlBase + "/appusers/:id/comments",
          method: "POST"
        },

        // INTERNAL. Use AppUser.comments.createMany() instead.
        "::createMany::AppUser::comments": {
          isArray: true,
          url: urlBase + "/appusers/:id/comments",
          method: "POST"
        },
        ...
        // INTERNAL. Use AppUser.comments.destroyAll() instead.
        "::delete::AppUser::comments": {
          url: urlBase + "/appusers/:id/comments",
          method: "DELETE"
        },

        // INTERNAL. Use AppUser.comments.count() instead.
        "::count::AppUser::comments": {
          url: urlBase + "/appusers/:id/comments/count",
          method: "GET"
        },

        // INTERNAL. Use Instructor.comments.findById() instead.
        "::findById::Instructor::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/comments/:fk",
        ...
        // INTERNAL. Use Instructor.comments.destroyById() instead.
        "::destroyById::Instructor::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/comments/:fk",
        ...
        // INTERNAL. Use Instructor.comments.updateById() instead.
        "::updateById::Instructor::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/instructors/:id/comments/:fk",
        ...
        // INTERNAL. Use Instructor.comments.createMany() instead.
        "::createMany::Instructor::comments": {
          isArray: true,
          url: urlBase + "/instructors/:id/comments",
          method: "POST"
        },
        ...
        // INTERNAL. Use Instructor.comments.count() instead.
        "::count::Instructor::comments": {
          url: urlBase + "/instructors/:id/comments/count",
          method: "GET"
        },

        // INTERNAL. Use Student.comments.findById() instead.
        "::findById::Student::comments": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/students/:id/comments/:fk",
        ...
        // INTERNAL. Use Student.comments.createMany() instead.
        "::createMany::Student::comments": {
          isArray: true,
          url: urlBase + "/students/:id/comments",
          method: "POST"
        },
    ...
    */
    R.modelName = "Comment";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Comment#publication
         * @methodOf lbServices.Comment
         *
         * @description
         *
         * Fetches belongsTo relation publication.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.publication = function() {
          var TargetResource = $injector.get("Publication");
          var action = TargetResource["::get::Comment::publication"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__get__image
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__create__image
         * @methodOf lbServices.Course
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__update__image
         * @methodOf lbServices.Course
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__destroy__image
         * @methodOf lbServices.Course
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__findById__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         ...
         * </em>
         */
        "prototype$__findById__modules__videos": {
          params: {
          'nk': '@nk',
          'fk': '@fk'
          },
          url: urlBase + "/courses/:id/modules/:nk/videos/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__destroyById__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        "prototype$__destroyById__modules__videos": {
          params: {
          'nk': '@nk',
          'fk': '@fk'
          },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__updateById__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         ...
         * </em>
         */
        "prototype$__updateById__modules__videos": {
          params: {
          'nk': '@nk',
          'fk': '@fk'
          },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__get__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         * Queries videos of CourseModule.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        "prototype$__get__modules__videos": {
          isArray: true,
          params: {
          'nk': '@nk'
          },
          url: urlBase + "/courses/:id/modules/:nk/videos",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__create__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         ...
         * </em>
         */
        "prototype$__create__modules__videos": {
          params: {
          'nk': '@nk'
          },
          url: urlBase + "/courses/:id/modules/:nk/videos",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__delete__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         ...
         * This method returns no data.
         */
        "prototype$__delete__modules__videos": {
          params: {
          'nk': '@nk'
          },
          url: urlBase + "/courses/:id/modules/:nk/videos",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Course#prototype$__count__modules__videos
         * @methodOf lbServices.Course
         *
         * @description
         *
         * Counts videos of CourseModule.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `nk` – `{*}` - Foreign key for modules.
         ...
         *  - `count` – `{number=}` - 
         */
        "prototype$__count__modules__videos": {
          url: urlBase + "/courses/:id/modules/:nk/videos/count",
          method: "GET"
        },
      }
    );
